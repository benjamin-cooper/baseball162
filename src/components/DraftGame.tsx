...
function sortPlayers(players: Player[], key: SortKey): Player[] {
  return [...players].sort((a, b) => {
    ...
    switch (key) {
      ...
      case 'war':
      default:
        // WAR is designed to be cross-position comparable, making it the right
        // key for BEST. Simulation scores are not comparable across positions
        // (CL and batter scores live on different scales).
